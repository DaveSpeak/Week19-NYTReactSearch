				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "number", className: "form-control text-center", id: "startYear", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"h4",
								{ className: "" },
							...
							React.createElement("input", { type: "number", className: "form-control text-center", id: "endYear", onChange: this.handleChange, required: true }),
							React.createElement("br", null),
							React.createElement(
								"button",
				...
				React.createElement(
					...
					this.props.results.map(function (search, i, j) {
						...
						return React.createElement(
							...
							React.createElement(
								'button',
								{ key: j, type: 'button', className: 'btn btn-primary', id: ident, onClick: buttonClick },
								'Save'
							)
						);
					})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(location, startYear, endYear) {

			//Call the query
			var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=" + nytAPI + "&q=" + location + "&begin_date=" + startYear + "0101" + "&end_date=" + endYear + "0101";
